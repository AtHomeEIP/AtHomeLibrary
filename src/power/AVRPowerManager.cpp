#include "AtHomeConfig.h"
    ...
    !defined(DISABLE_AVR_POWER_MANAGEMENT) && defined(__AVR__)
...
AVRPowerManagement& AVRPowerManagement::operator=(
    const AVRPowerManagement& other) {
  return *this;
}
...
#endif /* !defined(DISABLE_POWER_MANAGEMENT) && \
          !defined(DISABLE_AVR_POWER_MANAGEMENT) && defined(__AVR__) */