...
namespace storage {
/**
 * This class is only available on AVR platforms using Arduino, as it is a
 * wrapper of Arduino EEPROM library to implement non-volatile storage on AVR
 * mcu.
 *
 * Usage is simple, just create an instance of this object and set is as the
 * storage interface of your module using its setStorage method:
 *
 * \code{.cpp}
 * #include <AtHome.h>
 *
