...
class NativeArduinoESPWiFiCommunicator : public AWiFiCommunicator {
 public:
  ...
  NativeArduinoESPWiFiCommunicator(const NativeArduinoESPWiFiCommunicator &) =
      delete;
  NativeArduinoESPWiFiCommunicator &operator=(
      const NativeArduinoESPWiFiCommunicator &) = delete;
  ~NativeArduinoESPWiFiCommunicator();
