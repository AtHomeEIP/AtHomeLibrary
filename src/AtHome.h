...
using TMP36GZTemperatureSensor5V =
    athome::sensor::TMP36GZTemperatureSensor<5000000, 10>;
using TMP36GZTemperatureSensor3V3 =
    athome::sensor::TMP36GZTemperatureSensor<3300000, 10>;
...
using LDRLuminositySensor5V =
    athome::sensor::LDRLuminositySensor<5000000, 10, 10000>;
using LDRLuminositySensor3V3 =
    athome::sensor::LDRLuminositySensor<3300000, 10, 10000>;
...
#endif /* defined(ARDUINO) && (defined(__ATmega328__) ||         \
          defined(__ATmega32U4__) || defined(__ATmega2560__)) && \
          !defined(DISABLE_GROVE_DIGITAL_LIGHT_SENSOR) */
...
using athome::display::PWMLED;
    ...
    !defined(__PIC32MX__) && !defined(DISABLE_NEOPIXEL)
...
#if defined(ESP8266) && defined(ARDUINO) && !defined(DISABLE_NATIVE_ESP_COM)
